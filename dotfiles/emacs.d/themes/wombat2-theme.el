...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; outline
   ;; These are redefinitions of the default.
   ...
   ;; `(org-date ((,class (:inherit ))))
   ;; `(org-document-info ((,class (:inherit ))))
   `(org-document-info-keyword ((,class (:inherit shadow))))
   ;; `(org-document-title ((,class (:inherit ))))
   ;; `(org-done ((,class (:inherit ))))
   ;; `(org-ellipsis ((,class (:inherit ))))
   ;; `(org-footnote ((,class (:inherit ))))
   ;; `(org-formula ((,class (:inherit ))))
   ;; `(org-headline-done ((,class (:inherit ))))
   ;; `(org-hide ((,class (:inherit ))))
   ...
   ;; `(org-scheduled ((,class (:inherit ))))
   ;; `(org-scheduled-previously ((,class (:inherit ))))
   ;; `(org-scheduled-today ((,class (:inherit ))))
   ;; `(org-sexp-date ((,class (:inherit ))))
   `(org-special-keyword ((,class (:inherit font-lock-keyword-face))))
   ;; `(org-table ((,class (:inherit ))))
   `(org-tag ((,class (:weight bold))))
   ;; `(org-todo ((,class (:inherit ))))
   `(org-upcoming-deadline ((,class (:inherit ))))
